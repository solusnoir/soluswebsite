document.addEventListener('DOMContentLoaded', () => {
    ...
    const sideNav = document.querySelector('.side-nav'); // Sidebar for mobile view

    // Ensure the navbar is visible by default on non-index pages
    ...
    window.addEventListener('scroll', function () {
        ...
        // Toggle visibility for navbar based on scroll position and page
    ...
    menuToggle.addEventListener('click', () => {
        navLinks.classList.toggle('active'); // Toggle visibility for nav-links
        menuToggle.classList.toggle('open'); // Update toggle button appearance
        sideNav.classList.toggle('active'); // Toggle visibility for sidebar menu
    });
